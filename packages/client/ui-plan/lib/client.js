window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\Claude-project\deepseek-harness-win7\reference\deepseek-harness\packages\client\ui-plan\src\client\PlanModeControl.module.css.mjs
		const css = ".ad76cG_wrap{align-items:center;gap:6px;display:inline-flex}.ad76cG_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.ad76cG_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.ad76cG_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}.ad76cG_chip:disabled{opacity:.6;cursor:default}.ad76cG_close{color:currentColor;align-items:center;display:inline-flex}.ad76cG_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";

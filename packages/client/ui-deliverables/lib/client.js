window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Claude-project\deepseek-harness-win7\reference\deepseek-harness\packages\client\ui-deliverables\src\client\ProducedFiles.module.css.mjs
		const css = "._12uKwW_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}._12uKwW_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}._12uKwW_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}._12uKwW_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}._12uKwW_file:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}._12uKwW_file:focus-visible,._12uKwW_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}._12uKwW_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}._12uKwW_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}._12uKwW_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}._12uKwW_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}._12uKwW_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			"file": "_12uKwW_file",
			"label": "_12uKwW_label",
			"measure": "_12uKwW_measure",
			"more": "_12uKwW_more",
			"probe": "_12uKwW_probe",
			"root": "_12uKwW_root",
			"row": "_12uKwW_row",
			"showFolder": "_12uKwW_showFolder"
		};
		//#endregion
